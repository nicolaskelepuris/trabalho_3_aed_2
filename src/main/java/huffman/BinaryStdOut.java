...
public final class BinaryStdOut {
    ...
    private static void initialize(FileOutputStream stream) {
   ...
   /**
     ...
     */
    private static void writeBit(boolean bit, FileOutputStream stream) {
        if (!isInitialized) initialize(stream);
        ...
        n++;
        if (n == 8) clearBuffer(stream);
    } 

   /**
     * Writes the 8-bit byte to standard output.
     */
    private static void writeByte(int x, FileOutputStream stream) {
        if (!isInitialized) initialize(stream);
    ...
    private static void clearBuffer(FileOutputStream stream) {
        if (!isInitialized) initialize(stream);
   ...
   /**
     ...
     */
    public static void flush(FileOutputStream stream) {
        clearBuffer(stream);
        try {
            out.flush();
        }
   ...
   /**
     ...
     */
    public static void write(boolean x, FileOutputStream stream) {
        writeBit(x, stream);
    } 
   ...
   /**
     ...
     */
    public static void write(byte x, FileOutputStream stream) {
        writeByte(x & 0xff, stream);
    }
   ...
   /**
     ...
     */
    public static void write(int x, FileOutputStream stream) {
        writeByte((x >>> 24) & 0xff, stream);
        writeByte((x >>> 16) & 0xff, stream);
        writeByte((x >>>  8) & 0xff, stream);
        writeByte((x >>>  0) & 0xff, stream);
    }
   ...
   /**
     ...
     */
    public static void write(int x, int r, FileOutputStream stream) {
        if (r == 32) {
            write(x, stream);
            return;
        }
   ...
   /**
     ...
     */
    public static void write(double x, FileOutputStream stream) {
        write(Double.doubleToRawLongBits(x), stream);
    }
   ...
   /**
     ...
     */
    public static void write(long x, FileOutputStream stream) {
        writeByte((int) ((x >>> 56) & 0xff), stream);
        writeByte((int) ((x >>> 48) & 0xff), stream);
        writeByte((int) ((x >>> 40) & 0xff), stream);
        writeByte((int) ((x >>> 32) & 0xff), stream);
        writeByte((int) ((x >>> 24) & 0xff), stream);
        writeByte((int) ((x >>> 16) & 0xff), stream);
        writeByte((int) ((x >>>  8) & 0xff), stream);
        writeByte((int) ((x >>>  0) & 0xff), stream);
    }
   ...
   /**
     ...
     */
    public static void write(float x, FileOutputStream stream) {
        write(Float.floatToRawIntBits(x), stream);
    }
   ...
   /**
     ...
     */
    public static void write(short x, FileOutputStream stream) {
        writeByte((x >>>  8) & 0xff, stream);
        writeByte((x >>>  0) & 0xff, stream);
    }
   ...
   /**
     ...
     */
    public static void write(char x, FileOutputStream stream) {
   ...
   /**
     ...
     * @throws IllegalArgumentException if {@code x} is not between 0 and 2<sup>r</sup> - 1.
     */
    public static void write(char x, int r, FileOutputStream stream) {
        if (r == 8) {
            write(x, stream);
            return;
        }
   ...
   /**
     ...
     * between 0 and 255.
     */
    public static void write(String s, FileOutputStream stream) {
        for (int i = 0; i < s.length(); i++)
            write(s.charAt(i), stream);
    }
   ...
   /**
     ...
     */
    public static void write(String s, int r, FileOutputStream stream) {
        for (int i = 0; i < s.length(); i++)
            write(s.charAt(i), r, stream);
    }
}
